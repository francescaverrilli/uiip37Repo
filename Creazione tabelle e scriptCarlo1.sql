...
code varchar(2) not null, #qui ovviamente auto-increment non va essendo un varchar
name varchar(32) not null,
primary key (code)
);
...
#o si aggiungono alla fine o li aggiungi alla fine di ogni tabella però rispettando le dipendenze,
#ovvero crei prima la tabella verso cui si ha la dipendenza
ALTER TABLE brand
